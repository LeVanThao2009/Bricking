...
public class GameManager : MonoBehaviour
{
    ...
    private IEnumerator ShowGameWinWindow()
    {
        ...
        postGameMessageLabel.SetText("Bạn đã đạt đến chiều cao " + heightToWin + "m! Congratulations!");
    ...
    private IEnumerator ShowGameOverWindow()
    {
        ...
        postGameMessageLabel.SetText("Bạn đã đạt đến chiều cao: " + PlayerController.Instance.cameraController.heightMeter.Height + "m!");
        postGameWindowAnimator.SetBool("Show", true);
    }
